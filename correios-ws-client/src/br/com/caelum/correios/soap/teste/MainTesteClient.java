package br.com.caelum.correios.soap.teste;
...
public class MainTesteClient {
	...
	public static void main(String[] args) {
		  ...
		  String cepOrigemCaelumSP = "33940170"; //Caelum SP
		  String cepDestino = "33940130"; // Caelum RJ
		  String peso3kg = "3";
		  ...
		  CResultado resultado = cliente.calcPrecoPrazo(semCodigoEmpresa, semSenhaEmpresa, 
