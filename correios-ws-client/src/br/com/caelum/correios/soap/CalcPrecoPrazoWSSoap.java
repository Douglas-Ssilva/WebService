...
public interface CalcPrecoPrazoWSSoap {
     ...
     * @param sCepOrigem
     * @return
     *     returns br.com.caelum.correios.soap.CResultadoModal
     */
    ...
    @RequestWrapper(localName = "VerificaModal", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.VerificaModal")
    @ResponseWrapper(localName = "VerificaModalResponse", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.VerificaModalResponse")
     ...
     * 
     * @return
     *     returns br.com.caelum.correios.soap.Versao
     */
    @WebMethod(action = "http://tempuri.org/getVersao")
    @WebResult(name = "getVersaoResult", targetNamespace = "http://tempuri.org/")
    @RequestWrapper(localName = "getVersao", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.GetVersao")
    @ResponseWrapper(localName = "getVersaoResponse", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.GetVersaoResponse")
