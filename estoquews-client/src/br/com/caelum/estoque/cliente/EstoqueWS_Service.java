 ...
 * 
 */
@WebServiceClient(name = "estoqueWS", targetNamespace = "http://ws.estoque.caelum.com.br/", wsdlLocation = "http://localhost:8080/estoquews-server/estoqueWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/estoquews-server/estoqueWS?wsdl");
